...
struct AppColors {
    // MARK: - Primary Colors (Rouge Bordeaux) - Updated for Cute UI
    
    /// Deep wine - trust, seriousness (#5A0E24)
    ...
    /// Gradient violet-rose pour les boutons d'action
    ...
    /// Gradient rouge-violet (mix)
    static var redPurpleGradient: LinearGradient {
        LinearGradient(
            colors: [primaryRed, accentPurple],
            startPoint: .leading,
            endPoint: .trailing
        )
    }
